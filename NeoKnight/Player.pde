class Player extends Entity {
  ...
  //INSTANCE VARIABLES=========================================================================================
  boolean isLeft, isRight, isUp, isDown, wasLeft, wasRight, grab, next, prev, swit, attack, die, hurt, shoot, useKey, use, block, heal, useDoor, useShop;
  ...
  void useShops() {
    for (Shop shop : current.roomshops) {
      if (dist(shop.xCor, shop.yCor, xCor, yCor) < 60) {
        shop.open = !shop.open;
      }
    }
  }
